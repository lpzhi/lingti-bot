...
> 📺 **完整演示、截图和使用示例，请访问：[使用示例](./examples)**

主要功能演示：

- **[内置 Web 聊天界面](./examples#web-chat-ui)** — 多会话并行，零配置，`--webapp-port 8080` 一键启用
- **[定时任务](./examples#cron-jobs)** — 用自然语言创建 Cron Job，AI 自动生成内容
- **[企业微信文件助手](./examples#wecom-file)** — 自然语言管理和传输文件
- **[社交平台自动化](./examples#social-automation)** — AI 代操作知乎、小红书等内容平台
- **[浏览器自动化](./examples#browser-automation)** — 自然语言驾驭 Chrome，无需 Puppeteer/Node.js
